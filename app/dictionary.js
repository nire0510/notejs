...
module.exports = {
  ...
  "UNREGISTER_DESCRIPTION": "Unregister existing account and delete its notes",
  "GET_CURRENT_USERNAME": "Show with which user you are currently logged in",
  "GET_DESCRIPTION": "Read notes of user",
  "POST_DESCRIPTION": "Add a new note or update existing one",
  "POST_PRIVATE_DESCRIPTION": "Add a private note (visible only to users who have note's name)",
  ...
  "USER_HAS_X_NOTES": "Found %d note(s) for %s",
  ...
  "NOTE_VALIDATION": "NOTE is optional but if appears - should contain 2-40 alphanumeric characters",
  "NOTE2_VALIDATION": "NOTE is required and should contain at 2-40 alphanumeric characters",
